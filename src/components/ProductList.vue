<template>
  ...
  >
    ...
    <!-- 🔹 หัวข้อ -->
    <h2
      class="text-6xl font-extrabold text-white mb-16 font-playfair tracking-wide"
    >
      Products
    </h2>
    ...
    <!-- 🔹 Grid แสดงสินค้า -->
    <div
      class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 px-12 max-w-8xl mx-auto"
    >
      <div
